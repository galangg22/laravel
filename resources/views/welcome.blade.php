...
<body class="relative min-h-screen bg-gray-900">
  ...
  <div class="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 flex flex-col items-center text-center justify-center z-10 mt-10">
  <div class="text-center flex-1 w-full max-w-5xl">
    ...
    <p class="text-white  sm:text-lg md:text-xl mb-6 lg:mb-10">
  ...
  <div class="w-full aspect-video bg-gray-800 rounded-2xl border-4 border-green-400 flex items-center justify-center cursor-pointer group">
    <div class="w-28 h-28 xl:w-32 xl:h-32 bg-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
      <i class="fas fa-play text-gray-800 text-3xl xl:text-4xl ml-1"></i>
    </div>
  </div>
</div>
    ...
    <!-- Paragraf Section -->
    <div class="w-full mb-10 py-16">
      <div class="max-w-6xl mx-auto bg-black/80 backdrop-blur-sm rounded-2xl px-6 sm:px-12 lg:px-24 py-4 sm:py-6 lg:py-8 border border-green-400/50 shadow-2xl">
  ...
  <div class="features-box avoid">
    <h1 class="text-xl sm:text-2xl font-bold mb-4 text-center">
      <span>Menghindari</span><span class="icon red text-2xl sm:text-3xl">×</span>
    </h1>
    <ul class="text-base sm:text-lg leading-relaxed space-y-2">
      <li><span class="icon red text-lg sm:text-xl">×</span> Terus balik lagi ke hubungan yang nggak jelas.</li> <hr>
      <li><span class="icon red text-lg sm:text-xl">×</span> Menyalahkan diri sendiri setiap kali hubungan gagal.</li> <hr>
      <li><span class="icon red text-lg sm:text-xl">×</span> Ketergantungan pada validasi pasangan.</li> <hr>
      <li><span class="icon red text-lg sm:text-xl">×</span> Terjebak pola komunikasi toksik dan berulang.</li> <hr>
      <li><span class="icon red text-lg sm:text-xl">×</span> Takut disakiti tapi juga takut sendiri.</li>
    </ul>
  </div>
  ...
  <div class="features-box build">
   <h1 class="text-xl sm:text-2xl font-bold mb-4 text-center">
  <span class="inline-block align-middle">Membangun</span>
  <span class="icon green text-2xl sm:text-3xl inline-block align-middle">✓</span>
</h1>

    <ul class="text-base sm:text-lg leading-relaxed space-y-2">
      <li><span class="icon green text-lg sm:text-xl">✓</span> Lebih sadar sama emosi sendiri.</li> <hr>
      <li><span class="icon green text-lg sm:text-xl">✓</span> Tenang hadapi konflik karena tahu pola hubunganmu.</li> <hr>
      <li><span class="icon green text-lg sm:text-xl">✓</span> Membangun hubungan sehat tanpa manipulasi.</li> <hr>
      <li><span class="icon green text-lg sm:text-xl">✓</span> Percaya diri karena tahu batasan & kebutuhanmu.</li> <hr>
      <li><span class="icon green text-lg sm:text-xl">✓</span> Siap membuka hati tanpa kehilangan diri.</li>
    </ul>
  </div>
</div>
...
<section class="bg-gray-900 text-white py-16 px-6">
  ...
  <div class="flex-1 bg-gray-800 p-6 rounded-lg border border-green-500">
    <!-- Gambar -->
    <div class="mb-4">
      <img src="" alt="Ilustrasi Pola Lama" class="rounded-lg w-64 mx-auto object-cover aspect-video" />
    </div>
...
<div class="flex gap-6 items-start">
  ...
  <div class="flex-1 bg-gray-800 p-6 rounded-lg border border-green-500">
    <!-- Gambar -->
    <div class="mb-4">
      <img src="https://source.unsplash.com/400x225?love" alt="Ilustrasi Cinta dan Pelarian" class="rounded-lg w-64 mx-auto object-cover aspect-video" />
    </div>
...
<div class="flex gap-6 items-start">
  ...
  <div class="flex-1 bg-gray-800 p-6 rounded-lg border border-green-500">
    <!-- Gambar -->
    <div class="mb-4">
      <img src="https://source.unsplash.com/400x225?communication" alt="Ilustrasi Komunikasi Sehat" class="rounded-lg w-64 mx-auto object-cover aspect-video" />
    </div>
...
<div class="flex gap-6 items-start">
  ...
  <div class="flex-1 bg-gray-800 p-6 rounded-lg border border-green-500">
    <!-- Gambar -->
    <div class="mb-4">
      <img src="https://source.unsplash.com/400x225?healing" alt="Ilustrasi Penyembuhan Diri" class="rounded-lg w-64 mx-auto object-cover aspect-video" />
    </div>
...
<script>
  ...
  cards.forEach((card, index) => {
    ...
    div.className = `card-gradient rounded-xl overflow-hidden transform transition duration-300 ${isHovered ? 'scale-105 shadow-lg' : 'scale-100'}`;
    div.style.boxShadow = isHovered ? "0 0 30px rgba(0, 255, 0, 0.5)" : "0 0 20px rgba(0, 255, 0, 0.3)";

    div.innerHTML = `
      <div class="relative w-full h-40 md:h-48 lg:h-56 overflow-hidden">
        <img src="${card.image}" alt="${card.alt}" class="object-cover w-full h-full" />
        <div class="absolute top-0 left-0 w-full h-12 flex items-center px-4">
          <h3 class="text-white text-sm md:text-base font-semibold truncate w-full text-center">
            ${card.title}
          </h3>
        </div>
      </div>
      <div class="p-4 text-green-200 text-sm leading-relaxed text-center">
        ${card.text}
      </div>
    `;
...
@media (max-width: 768px) {
  ...
  .card img {
    ...
    height: 180px;
        ...
        <section>
            <h2 class="tahukah-kamu-title py-16">Tahukah Kamu?</h2>
<div class="container flex justify-center">
  <div class="card flex justify-center" data-index="0">
...
cards.forEach((card, index) => {
  ...
  <div>
<section id="cta-section" class="min-h-screen w-full gradient-bg flex flex-col items-center justify-center px-4 py-10">
...
<script>
  document.getElementById("btn-start").addEventListener("click", function () {
   ...
   <div class="card-gradient rounded-xl p-4 sm:p-6 md:p-8 glow-effect mt-20">
  <div class="flex flex-row items-start gap-4 sm:gap-6">
    <!-- Foto di dalam card, sisi kiri -->
    <div class="flex-shrink-0">
      <img
        src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"
        alt="Alain de Botton"
        class="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-lg object-cover shadow-lg"
      />
    </div>

    <!-- Konten teks -->
    <div class="text-left flex-1">
      <p class="testimonial-text text-sm sm:text-base lg:text-lg text-white mb-4">
      ...
      <div class="testimonial-author text-white">
        <p class="font-semibold">— Alain de Botton</p>
        <p class="italic text-sm sm:text-base">Penulis buku "The Course of Love"</p>
      </div>
    </div>
  </div>
</div>
...
.gap-6 {
  ...
  <ul class="space-y-2">
    <li class="flex items-start justify-between gap-4">
      <span>Menyimpan dendam, tapi nggak pernah benar-benar memproses luka</span>
      <span class="text-white">•</span>
    </li>
    <li class="flex items-start justify-between gap-4">
      <span>Menyalahkan masa lalu, tapi enggan melihat ke dalam diri</span>
      <span class="text-white">•</span>
    </li>
    <li class="flex items-start justify-between gap-4">
      <span>Menghindari hubungan sehat, karena "kayaknya terlalu asing"</span>
      <span class="text-white">•</span>
    </li>
    <li class="flex items-start justify-between gap-4">
      <span>Bilangnya kuat, tapi di dalam hati masih ketakutan</span>
      <span class="text-white">•</span>
    </li>
    <li class="flex items-start justify-between gap-4">
      <span>Nggak percaya bahwa cinta bisa sembuh, bisa jadi aman</span>
      <span class="text-white">•</span>
    </li>
  </ul>
</div>
  ...
  <ul class="space-y-2">
    <li class="flex items-start gap-4">
      <span class="text-white">•</span>
      <span>Belajar memaafkan, tanpa harus melupakan</span>
    </li>
    <li class="flex items-start gap-4">
      <span class="text-white">•</span>
      <span>Mau melihat ulang pola yang menyakiti, dengan jujur</span>
    </li>
    <li class="flex items-start gap-4">
      <span class="text-white">•</span>
      <span>Siap membangun relasi dengan fondasi yang sehat</span>
    </li>
    <li class="flex items-start gap-4">
      <span class="text-white">•</span>
      <span>Berani mengakui kelemahan, bukan untuk dikasihani tapi untuk disembuhkan</span>
    </li>
    <li class="flex items-start gap-4">
      <span class="text-white">•</span>
      <span>Tahu bahwa cinta itu mungkin... tapi dimulai dari dalam</span>
    </li>
  </ul>
</div>
